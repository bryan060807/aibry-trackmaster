...
function createCorsHeaders(config) {
  return (req, res, next) => {
    ...
    res.setHeader('Access-Control-Allow-Headers', 'Authorization, Content-Type, Prefer, X-Album, X-Album-Artist, X-Async-Export, X-Artist, X-Comment, X-Copyright, X-Date, X-Duration-Seconds, X-File-Name, X-Format, X-Genre, X-Release-Date, X-Release-Year, X-Title, X-Track-Album, X-Track-Album-Artist, X-Track-Artist, X-Track-Comment, X-Track-Genre, X-Track-Title, X-Year');
